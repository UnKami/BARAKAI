      ...
      <main className="relative z-10">
        ...
        <section className="relative py-32 px-4 text-center">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="relative z-10 max-w-4xl mx-auto bg-[#110a1f] border border-purple-500/30 p-12 rounded-2xl shadow-[0_0_50px_rgba(168,85,247,0.2)]"
          >
            <h2 className="text-4xl md:text-5xl font-display font-bold mb-6 text-white">
              Start Your Legend
            </h2>
            <p className="text-gray-300 mb-10 max-w-2xl mx-auto text-lg">
              The Tower is infinite, but your story is unique. Join the ecosystem where your gameplay creates permanent value.
            </p>
